...
public class UserDao {
    ...
    public static final String USER_COLUMN_AVATER_ID="m_user_avater_id";
    public static final String USER_COLUMN_AVATER_PATH="m_user_avater_path";
    public static final String USER_COLUMN_AVATER_SUFFIX="m_user_avater_suffix";
    public static final String USER_COLUMN_AVATER_TYPE="m_user_avater_type";
    public static final String USER_COLUMN_AVATER_LASTUPDATE_TIME="m_user_avater_lastupdate_time";
